    ...
    pipeline {
        ...
        stages {
            ...
            stage('check the release') {
                ...
                steps {
                    script {
                        def UPLOAD_STATUS=sh(returnStdout: true, script: 'curl -L -s http://172.31.5.42:8081/service/rest/repository/browse/${COMPONENT} | grep \${COMPONENT}-\${TAG_NAME}.zip || true')
                        print UPLOAD_STATUS
                    }
